...
jQuery.effects || function(f, j) {
    ...
    f.effects.animateClass = function(c, a, b,
        d) { if (f.isFunction(b)) { d = b;
            ...
            r = p(o.call(this));
            e.attr("class", v);
            e.animate(u(h, r), { queue: false, duration: a, easing: b, complete: function() { f.each(q, function(w, i) { c[i] && e[i + "Class"](c[i]) }); if (typeof e.attr("style") == "object") { e.attr("style").cssText = "";
